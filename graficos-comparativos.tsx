  ...
  return (
    <div className="flex flex-col space-y-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle>Costos acumulados por alternativa energética</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={costosAcumulados}>
                ...
                <Tooltip formatter={(value) => [`$${new Intl.NumberFormat('es-CO').format(value)} COP`, '']} />
                <Legend />
                <Line 
                  type="monotone" 
          ...
          <div className="mt-4 text-sm">
            <h4 className="font-medium mb-1">Interpretación del gráfico:</h4>
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><span className="font-medium">Punto clave:</span> Los paneles solares generan un ahorro acumulado superior a $51 millones COP al cabo de 20 años comparado con la red eléctrica.</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Retorno de inversión - Paneles solares</CardTitle>
            <CardDescription>Flujo de caja acumulado de la inversión en sistema fotovoltaico</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={retornoInversion}>
                  ...
                  <XAxis dataKey="year" />
                  <YAxis tickFormatter={(value) => `$${Math.round(value/1000000)}M`} />
                  <Tooltip formatter={(value) => [`$${new Intl.NumberFormat('es-CO').format(value)} COP`, 'Flujo acumulado']} />
                  <Bar dataKey="flujo" name="Flujo acumulado" fill={flujo => (flujo.flujo < 0 ? "#FF8042" : "#00C49F")} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div className="mt-4 text-sm">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Emisiones CO₂ (20 años) - Toneladas</CardTitle>
            <CardDescription>Comparativa de impacto ambiental por alternativa</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip formatter={(value) => [`${value} toneladas CO₂`, '']} />
                  <Legend />
                </PieChart>
              </ResponsiveContainer>
            </div>
            <div className="mt-4 text-sm">
              <h4 className="font-medium mb-1">Interpretación del gráfico:</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li>Los paneles solares generan <span className="font-medium">8 veces menos emisiones</span> que la red eléctrica.</li>
                <li>El generador a gas tiene el mayor impacto ambiental, con <span className="font-medium">11.5 veces más emisiones</span> que los paneles solares.</li>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Estructura de costos por alternativa</CardTitle>
          <CardDescription>Desglose de los diferentes componentes de costos para cada opción</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Análisis de sensibilidad - Tiempo de retorno (años)</CardTitle>
          <CardDescription>Impacto de diferentes escenarios en la viabilidad de las alternativas</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis label={{ value: 'Años', angle: -90, position: 'insideLeft' }} />
                <Tooltip />
                <Legend />
                <Bar dataKey="panelesSolares" name="Paneles solares" fill="#00C49F" />
                <Bar dataKey="generadorGas" name="Generador gas" fill="#FF8042" />
...
export default EnergiaComparativa;
